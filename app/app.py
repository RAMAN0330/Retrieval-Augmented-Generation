...
def vector_embedding():
    ...
    if 'vectors' not in st.session_state:
        ...
        st.session_state.loader = PyPDFDirectoryLoader('End-to-End_RAG_and_LangChain_Project/us-census-data')
        ...
        st.session_state.vectors = ObjectBox.from_documents(st.session_state.final_documents, st.session_state.embeddings, embedding_dimensions=768, db_directory='End-to-End_RAG_and_LangChain_Project/objectbox')
